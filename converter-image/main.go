...
// ConvertPubSub receives and processes a Pub/Sub push message.
func ConvertPubSub(w http.ResponseWriter, r *http.Request) {
	var m PubSubMessage
	...
	if err := imagemagick.ConvertImageToPNG(r.Context(), e); err != nil {
		log.Printf("imagemagick.ConvertImageToPNG: %v", err)
